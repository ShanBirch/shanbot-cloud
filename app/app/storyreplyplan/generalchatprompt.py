...
3. **Bio-Driven Question Examples**:
   ...
   - **Lifestyle**: "How's the [pet] going?" (if they have pets), "Tried any good restaurants lately?" (if foodies), "Been anywhere cool recently?" (if they travel)
   - **Conversation Flow**: Build deeper into topics they've mentioned rather than surface-level questions
