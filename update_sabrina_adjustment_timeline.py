#!/usr/bin/env python3
"""Update Sabrina's calorie adjustment PDF with corrected 4-6 week timeline"""
...
def create_sabrina_adjustment_pdf_updated():
    """Create Sabrina's calorie adjustment explanation PDF with corrected timeline"""

    print("=== UPDATING SABRINA'S CALORIE ADJUSTMENT PDF (4-6 WEEK TIMELINE) ===")
    ...
    print(f"\n⏰ UPDATED TIMELINE: 4-6 weeks optimal adjustment period")
    ...
    content.append(
        Paragraph("Phase 2: Steady Progress (Weeks 3-4)", subheading_style))
    ...
    content.append(
        Paragraph("Phase 3: Next Adjustment Point (Weeks 4-6)", subheading_style))

    phase3_text = """
    <b>What will happen:</b> Your metabolism will begin adapting to 1,750 calories. Weight loss may slow down 
    or plateau around the 4-6 week mark.
    <br/><br/>
    ...
    adjust_text = """
    <b>Optimal Review Period: 4-6 weeks</b>
    <br/><br/>
    <b>Plateau Indicators (typically around week 4-6):</b>
    • No scale movement for 7-10 days
    ...
    • Taking a planned diet break to reset metabolism
    <br/><br/>
    <b>Remember:</b> Plateaus are NORMAL and expected around the 4-6 week mark. They don't mean you're doing 
    anything wrong – they mean your body is adapting (which is what bodies do!). We'll always have a plan B, C, and D.
    """
    ...
    • We'll reassess in 4-6 weeks for optimal timing
    <br/><br/>
    ...
    print(f"\n✅ SUCCESS! Sabrina's UPDATED adjustment PDF created!")
    print(f"📄 Location: {pdf_path}")
    print(f"📊 PDF size: {pdf_size:,} bytes ({pdf_size_kb:.1f} KB)")

    print(f"\n📋 UPDATED PDF Contents:")
    print(f"   • Calorie adjustment explanation (1900 → 1750)")
    print(f"   • Scientific rationale for the change")
    print(f"   • 3-phase timeline with 4-6 week optimal review")
    print(f"   • What to experience during adaptation")
    print(f"   • Success strategies for the transition")
    print(f"   • Future adjustment planning (4-6 weeks)")
    print(f"   • Motivational support and encouragement")

    print(f"\n🎯 KEY TIMELINE UPDATES:")
    print(f"   • Phase 3: Next Adjustment Point (Weeks 4-6) ← UPDATED")
    print(f"   • Optimal Review Period: 4-6 weeks ← UPDATED")
    print(f"   • Plateau indicators: 7-10 days vs 10-14 days ← UPDATED")
    print(f"   • Assessment timing: Week 4-6 vs Week 6-8 ← UPDATED")

    return pdf_path


if __name__ == "__main__":
    create_sabrina_adjustment_pdf_updated()

    print(f"\n🌟 UPDATED CALORIE ADJUSTMENT SUMMARY:")
    ...
    print(f"   🔄 Next review: 4-6 weeks (CORRECTED TIMELINE)")
    print(f"   💪 Goal: Continue body recomposition progress")

    print(f"\n✅ Ready to support Sabrina through this transition with optimal timing!")
